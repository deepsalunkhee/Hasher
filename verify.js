function verify(databasehash,stringtoverify){
    ...
    // Pre-processing
    let m = [];
    for (let i = 0; i < stringtoverify.length; i += 64) {
        let chunk = stringtoverify.slice(i, i + 64);
    ...
    const originalLength = stringtoverify.length * 8;
    ...
    for (let i = 0; i < m.length; i += 64) {
        ...
        // Prepare stringtoverify schedule
        for (let t = 0; t < 16; t++) {
